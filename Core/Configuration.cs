...
namespace RepoAP
{
    public class PluginConfig
    {
        ...
        {
            EnemyWeightIncrease = cfg.Bind("Bad Luck Protection", "Spawn weight increase for unextracted enemy souls", 100,
            ...
            ValuableSubstitutionChance = cfg.Bind("Bad Luck Protection", "Chance to replace previously extracted valuables", 50,
