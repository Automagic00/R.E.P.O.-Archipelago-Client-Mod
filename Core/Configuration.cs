...
namespace RepoAP
{
    public class PluginConfig
    {
        ...
        public ConfigEntry<uint> EnemyWeightIncrease;
        ...
        public PluginConfig(ConfigFile cfg)
        {
            ...
            EnemyWeightIncrease = cfg.Bind<uint>("Bad Luck Protection", "Spawn weight increase for unextracted enemy souls", 50,
            ...
            ValuableSubstitutionChance = cfg.Bind<uint>("Bad Luck Protection", "Chance to replace previously extracted valuables", 40,
